...
pub fn defs() -> Vec<OpDef> {
    vec![
        ...
        OpDef { name: "sub", arity: 2, state: StateDecl::None, kernel: sub },
        OpDef { name: "div", arity: 2, state: StateDecl::None, kernel: div },
        OpDef { name: "mod", arity: 2, state: StateDecl::None, kernel: mod_ },
        OpDef { name: "neg", arity: 1, state: StateDecl::None, kernel: neg },
        OpDef { name: "abs", arity: 1, state: StateDecl::None, kernel: abs },
        OpDef { name: "min", arity: 2, state: StateDecl::None, kernel: min },
        OpDef { name: "max", arity: 2, state: StateDecl::None, kernel: max },
        OpDef { name: "pow", arity: 2, state: StateDecl::None, kernel: pow },
        OpDef { name: "sqrt", arity: 1, state: StateDecl::None, kernel: sqrt },
        OpDef { name: "floor", arity: 1, state: StateDecl::None, kernel: floor },
        OpDef { name: "ceil", arity: 1, state: StateDecl::None, kernel: ceil },
    ]
}
