...
pub fn defs() -> Vec<OpDef> {
    vec![
        OpDef { name: "gt", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: gt, cpp_kernel: Some("return ({a0} > {a1}) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "gte", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: gte, cpp_kernel: Some("return ({a0} >= {a1}) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "lt", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: lt, cpp_kernel: Some("return ({a0} < {a1}) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "lte", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: lte, cpp_kernel: Some("return ({a0} <= {a1}) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "eq", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: eq, cpp_kernel: Some("return ({a0} == {a1}) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "neq", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: neq, cpp_kernel: Some("return ({a0} != {a1}) ? 1.0 : 0.0;"), emit_cpp_call: None },
    ]
}
