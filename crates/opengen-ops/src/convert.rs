...
pub fn defs() -> Vec<OpDef> {
    vec![
        ...
        OpDef { name: "trunc", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: trunc, cpp_kernel: Some("return ({a0} > 0.0 ? std::floor({a0}) : std::ceil({a0}));"), emit_cpp_call: None },
        ...
        OpDef { name: "mtof", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: mtof, cpp_kernel: Some("return 440.0 * std::pow(2.0, ({a0} - 69.0) / 12.0);"), emit_cpp_call: None },
        OpDef { name: "ftom", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: ftom, cpp_kernel: Some("return 69.0 + 12.0 * std::log2({a0} / 440.0);"), emit_cpp_call: None },
        OpDef { name: "dbtoa", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: dbtoa, cpp_kernel: Some("return std::pow(10.0, {a0} / 20.0);"), emit_cpp_call: None },
        OpDef { name: "atodb", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: atodb, cpp_kernel: Some("return std::pow(10.0, {a0} / 20.0);"), emit_cpp_call: None },
        OpDef { name: "mstosamps", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: mstosamps, cpp_kernel: Some("return {a0} * (samplerate / 1000.0);"), emit_cpp_call: None },
        OpDef { name: "sampstoms", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: sampstoms, cpp_kernel: Some("return {a0} * (1000.0 / samplerate);"), emit_cpp_call: None },
        ...
        OpDef { name: "round", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: round, cpp_kernel: Some("return std::round({a0});"), emit_cpp_call: None },
        ...
        OpDef { name: "fixnan", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: fixnan, cpp_kernel: Some("return std::isnan({a0}) ? 0.0 : {a0};"), emit_cpp_call: None },
        OpDef { name: "fixdenorm", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: fixdenorm, cpp_kernel: Some("return ({a0} != 0.0 && std::abs({a0}) < 2.2250738585072014e-308) ? 0.0 : {a0};"), emit_cpp_call: None },
        ...
        OpDef { name: "and", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: and, cpp_kernel: Some("return ({a0} != 0.0 && {a1} != 0.0) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "or", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: or, cpp_kernel: Some("return ({a0} != 0.0 || {a1} != 0.0) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "not", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: not, cpp_kernel: Some("return ({a0} == 0.0) ? 1.0 : 0.0;"), emit_cpp_call: None },
        OpDef { name: "xor", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: xor, cpp_kernel: Some("return (({a0} != 0.0) != ({a1} != 0.0)) ? 1.0 : 0.0;"), emit_cpp_call: None },
        // Alias: clamp -> clip
