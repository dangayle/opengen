...
pub fn defs() -> Vec<OpDef> {
    vec![
        OpDef { name: "sign", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: sign },
        OpDef { name: "fract", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: fract },
        OpDef { name: "trunc", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: trunc },
        OpDef { name: "absdiff", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: absdiff },
        OpDef { name: "sinh", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: sinh },
        OpDef { name: "cosh", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: cosh },
        OpDef { name: "tanh", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: tanh },
        OpDef { name: "asinh", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: asinh },
        OpDef { name: "acosh", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: acosh },
        OpDef { name: "atanh", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: atanh },
        OpDef { name: "degrees", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: degrees },
        OpDef { name: "radians", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: radians },
        OpDef { name: "mtof", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: mtof },
        OpDef { name: "ftom", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: ftom },
        OpDef { name: "dbtoa", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: dbtoa },
        OpDef { name: "atodb", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: atodb },
        OpDef { name: "mstosamps", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: mstosamps },
        OpDef { name: "sampstoms", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: sampstoms },
        OpDef { name: "rsub", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: rsub },
        OpDef { name: "rdiv", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: rdiv },
        OpDef { name: "switch", arity: 3, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: switch },
        OpDef { name: "round", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: round },
        OpDef { name: "int", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: int },
        OpDef { name: "bool", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: bool },
        OpDef { name: "fixnan", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: fixnan },
        OpDef { name: "fixdenorm", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: fixdenorm },
        OpDef { name: "triangle", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: triangle },
        OpDef { name: "and", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: and },
        OpDef { name: "or", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: or },
        OpDef { name: "not", arity: 1, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: not },
        OpDef { name: "xor", arity: 2, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: xor },
        // Alias: clamp -> clip
        OpDef { name: "clamp", arity: 3, state: StateDecl::None, deferred_ports: &[], update: None, init: None, kernel: crate::range::clip },
    ]
}
